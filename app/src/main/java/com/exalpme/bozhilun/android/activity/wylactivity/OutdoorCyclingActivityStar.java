...
import com.exalpme.bozhilun.android.activity.wylactivity.wyl_util.Usermap;
import com.exalpme.bozhilun.android.activity.wylactivity.wyl_util.service.ConnectManages;
import com.exalpme.bozhilun.android.activity.wylactivity.wyl_util.service.library.MySinkingView;
import com.exalpme.bozhilun.android.base.BaseActivity;
import com.exalpme.bozhilun.android.net.OkHttpObservable;
import com.exalpme.bozhilun.android.rxandroid.DialogSubscriber;
...
public class OutdoorCyclingActivityStar extends BaseActivity implements LocationSource, com.amap.api.location.AMapLocationListener, AMap.OnMarkerClickListener, AMap.OnMapClickListener, OnMapReadyCallback {
    ...
    Timer timerb;
    com.exalpme.bozhilun.android.activity.wylactivity.wyl_util.GPSutils GPSutils;
    ...
    protected void initViews() {
      /*  mSM = (SensorManager) getSystemService(SENSOR_SERVICE);mSensor = mSM.getDefaultSensor(Sensor.TYPE_ORIENTATION);
        ...
        GPSutils = new com.exalpme.bozhilun.android.activity.wylactivity.wyl_util.GPSutils();
