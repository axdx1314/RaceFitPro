...
import com.exalpme.bozhilun.android.B18I.b18isystemic.B18IAppSettingActivity;
import com.exalpme.bozhilun.android.B18I.b18isystemic.B18IRankingListActivity;
import com.exalpme.bozhilun.android.B18I.b18isystemic.FindFriendActivity;
import com.example.bozhilun.android.R;
import com.exalpme.bozhilun.android.activity.MyPersonalActivity;
                ...
                if (!WatchUtils.isEmpty(imgHead)) {
                    if (userImageHead != null) {
                        ...
                        Glide.with(getActivity()).
                                ...
                                CropCircleTransformation(getActivity())).into(userImageHead);    //头像
                    }
                }
            } catch (JSONException e) {
                e.printStackTrace();
