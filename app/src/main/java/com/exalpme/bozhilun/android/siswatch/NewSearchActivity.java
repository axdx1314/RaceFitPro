package com.exalpme.bozhilun.android.siswatch;
...
import com.exalpme.bozhilun.android.activity.LoginActivity;
import com.exalpme.bozhilun.android.bleutil.MyCommandManager;
import com.exalpme.bozhilun.android.h9.H9HomeActivity;
import com.exalpme.bozhilun.android.siswatch.adapter.CustomBlueAdapter;
import com.exalpme.bozhilun.android.siswatch.bean.CustomBlueDevice;
import com.exalpme.bozhilun.android.siswatch.utils.BlueAdapterUtils;
import com.exalpme.bozhilun.android.siswatch.utils.HidUtil;
...
public class NewSearchActivity extends GetUserInfoActivity implements CustomBlueAdapter.OnSearchOnBindClickListener, SwipeRefreshLayout.OnRefreshListener {
            ...
            switch (msg.what) {
                ...
                case 10241024:
                    ...
                    if (!WatchUtils.isEmpty(m)) {
                        W30SBLEManage.mW30SBLEServices.connect(m);
                    }
                    break;
            }
    ...
    protected void onStart() {
        ...
        try {
            ...
            if (customBlueAdapter != null) customBlueAdapter.notifyDataSetChanged();
        } catch (Exception e) {
            e.getMessage();
        }
        ...
        public void onLeScan(BluetoothDevice bluetoothDevice, int rssi, byte[] scanRecord) {
            ...
            if (!WatchUtils.isEmpty(bleName) && bleName.length() >= 4) {//bleName.equals(B15P_BLENAME) || || bleName.substring(0,4).equals(B18I_BLENAME)
                if ((scanRecord[7] == 80 && scanRecord[8] == 80)
                        || bleName.substring(0, 3).equals(H9_BLENAME)
                        || bleName.substring(0, 3).equals("W30")) {//|| bleName.equals(B15PNAME)
...
//            }
                    ...
                    try {
                        ...
                        if (!WatchUtils.isEmpty(W30address)) {
                            //Log.d("=======点击绑定=====", bleName + "===" + W30address);
//                            W30SBLEManage instance = W30SBLEManage.getInstance(NewSearchActivity.this);
//                            MyApp.setmW30SBLEManage(instance);
//                            MyApp.setmW30SBLEManage(W30SBLEManage.getInstance(this));
//                            if (W30SBLEServices.isServiceRunning(this, "com.suchengkeji.android.w30sblelibrary.W30SBLEServices")) {
//                                Log.d("----W30SBLEServices----", "W30SBLEServices在运行");
//                            } else {
//                                MyApp.getmW30SBLEManage().openW30SBLEServices();
//                            }
                            W30SBLEManage.mW30SBLEServices.connect(W30address);
//                            if (W30SBLEManage.mW30SBLEServices != null) {
//
//                            } else {
//
//                                Message message = new Message();
//                                message.what = 10241024;
//                                message.obj = W30address;
